...
function focusaed(e) {
  e.parentElement.classList.contains('input-group') &&
    e.parentElement.classList.add('focuased');
}
function defocusaed(e) {
  e.parentElement.classList.contains('input-group') &&
    e.parentElement.classList.remove('foacused');
}
  ...
  (window.onload = function () {
    for (var e = document.querySelectorAll('input'), t = 0; t < e.length; t++)
      e[t].addEventListener(
        'focus',
        function (e) {
          this.parentElement.classList.add('is-focusaed');
        },
        !1
      ),
        ...
        e[t].addEventListener(
          ...
          function (e) {
            '' != this.value && this.parentElement.classList.add('is-filled'),
              this.parentElement.classList.remove('is-focusead');
          },
          !1
        );
